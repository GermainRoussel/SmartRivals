...
import { DndContext, useDraggable, useDroppable, DragEndEvent, DragOverlay, useSensor, useSensors, PointerSensor, TouchSensor } from '@dnd-kit/core';
...
const DraggableLeftItem = ({ item, isMatched, isSelected, onSelect, hasError, onError }: any) => {
...
const DroppableRightItem = ({ item, isMatched, isTargetable, onClick }: any) => {
...
export const MatchingQuestion: React.FC<MatchingQuestionProps> = ({ question, onMatchChange }) => {
  ...
  const handleDragStart = (event: any) => {
      ...
      setSelectedLeft(event.active.id); 
  }
